	...
	<div class="container">
		<div class="row my-5">
			<div class="col-md-8 offset-md-2 my-5">
				<div class="row">
					<div class="col-md-6">
						<form id="form_login_client">
							<div id="form_message_client"></div>
							...
							<button type="submit" class="btn btn-dark btn-block"><span id="client_sub">Client</span></button>
						</form>
						<br>
					...
					<div class="col-md-6">
						<form id="form_login_tech">
							<div id="form_message_tech"></div>
							<div class="form-group">
								<input
									type="email"
									class="form-control"
							...
							<button type="submit" class="btn btn-dark btn-block"><span id="tech_sub">Technician</span></button>
						</form>
						<br>
	      ...
	      <div class="modal-header">
	        ...
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		      ...
		      <div class="modal-footer">
		        ...
		        <button type="submit" class="btn btn-primary"><span id="subRC">SEND</span></button>
		      </div>
				</form>
	    </div>
	  </div>
